...
This reformulation is advantageous because it eliminates the additive structure, reducing the problem to repeated matrix multiplications and a single addition and subtraction. The final expression for \(\theta^{(t)}\) highlights the relationship between the parameters and the least squares solution:
\[
