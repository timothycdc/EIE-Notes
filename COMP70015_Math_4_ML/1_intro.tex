...
We model samples as distinct random variables \sidenote{\textbf{Question:} Why should we model these as distinct random variables? Aren't they all the same thing?
...
\marginnote{    \textbf{Why do we model samples as distinct random variables?}
...
\marginnote[-98pt]{    \refsb{Recommended Viewing}{
