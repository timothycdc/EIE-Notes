...
We model samples as distinct random variables \sidenote{\textbf{Why should we model these as distinct random variables? Aren't they all the same thing?} \smallskip
