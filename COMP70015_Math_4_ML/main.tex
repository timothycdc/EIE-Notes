...
\begin{itemize}
  \item COMP70015: Mathematics for Machine Learning
  \item Professor: \href{https://www.mattrwicker.com/}{Matthew Wicker}
\end{itemize}
...
\defb{Machine Learning}{
  Insert professor vs chatgpt definition here

  \begin{itemize}
    \item The study of algorithms that process a dataset to perform a task
  \end{itemize}
}
