...
\usepackage{graphicx, amssymb, amsfonts, amsmath, listings, multirow, hyperref, mathtools, svg, tikz, enumitem, minted, xfrac, multicol, subcaption}
...
\newtcolorbox[auto counter,number within=section]{commentbox}[2][]{%
    ...
    sharp corners=all,
    fonttitle=\bfseries,
    title=#2 \hfill  Author's Comment 
}


% For reference to source material:
